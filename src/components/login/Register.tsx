...
const Register = () => {
    ...
    const register = async () => {
        try {
            const res = await fetch(`${process.env.REACT_APP_BE_URL}/users/register`, {
                method: "POST",
                headers: {
                    ...
                    <Col lg={6} md={12}>
                        <Form onSubmit={handleSubmit} className="mb-3">
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" placeholder="Enter name" value={formValues.name} onChange={e => setFormValues({...formValues, name: e.target.value})}></Form.Control> 
                            </Form.Group>
                            <Form.Group className="mb-3">
                        ...
                        <p className="mt-3">Already got an account? <Link to="/login">Login here</Link></p>
                    </Col>
                </Row>
            </Container>
        </section>
